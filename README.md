...
![JavaFX Logo](https://img.shields.io/badge/JavaFX-ED8B00?style=for-the-badge&logo=java&logoColor=white) <div align="center"> <img src="https://cdn.jsdelivr.net/npm/@programming-languages-logos/java/java_64x64.png" alt="Java" width="50"> <span style="font-size: 24px; margin: 0 10px;">+</span> <img src="https://upload.wikimedia.org/wikipedia/en/thumb/8/87/JavaFX_Logo.png/64px-JavaFX_Logo.png" alt="JavaFX" width="50"> </div>
